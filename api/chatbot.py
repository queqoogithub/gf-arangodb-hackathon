...
if __name__ == "__main__":
    # query = "I am a software engineer who loves programming in Python and Java. I have a degree in Computer Science and enjoy reading books on technology."
    # query = "I interesred in wildlife and I have a degree in biology. I love to work with animals and I have a good communication skill."
    query = "I interested in data science and I have a degree in computer science. I have experience in Python and R programming"
